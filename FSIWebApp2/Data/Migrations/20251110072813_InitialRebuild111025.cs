...
namespace FSIWebApp2.Migrations
{
    /// <inheritdoc />
    public partial class InitialRebuild111025 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "FileMakerReference",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FileMakerName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NewFsiName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SQLDataType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GenericDataType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileMakerReference", x => x.Id);
                });
